...
namespace RecipeTracker.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByName = table.Column<string>(nullable: true, defaultValue: ""),
                    DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "sysdatetime()"),
                    DateUpdated = table.Column<DateTime>(nullable: false, defaultValueSql: "sysdatetime()"),
                    IsDeleted = table.Column<bool>(nullable: false),
                    UpdatedBy = table.Column<Guid>(nullable: false),
                    UpdatedByName = table.Column<string>(nullable: true, defaultValue: ""),
                    Cook = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: true, defaultValue: ""),
                    Picture = table.Column<byte[]>(nullable: true),
                    Prep = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
